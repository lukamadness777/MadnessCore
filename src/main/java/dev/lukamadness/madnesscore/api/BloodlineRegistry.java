...
public final class BloodlineRegistry {
    ...
    public static Bloodline register(Identifier id, Identifier speciesId, Text displayName, double weight) {
    ...
    public static Bloodline register(Identifier id, Identifier speciesId, String displayName, double weight) {
        return register(id, speciesId, Text.literal(displayName), weight);
    }

    public static Bloodline registerForAll(Identifier id, Text displayName, double weight) {
    ...
    public static Bloodline registerForAll(Identifier id, String displayName, double weight) {
        return register(id, null, Text.literal(displayName), weight);
    }
