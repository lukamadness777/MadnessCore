...
public class EyeDrawScreen extends Screen {
    ...
    public EyeDrawScreen(Screen parent, MadnessCoreConfig cfg, SkinRegion region) {
        super(Text.translatable("madnesscore.config.draw.title_eyes"));
        this.parent = parent;
        this.cfg = cfg;
        this.region = region;
    ...
    private void openPartSelector() {
        ...
        this.client.setScreen(new EyePartSelectScreen(this, cfg, region));
    }
