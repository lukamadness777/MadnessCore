...
import dev.lukamadness.madnesscore.client.render.renderer.DyeableLegginsRenderer;
...
public class DyeableLegginsItemClient extends DyeableLegginsItem {
    public DyeableLegginsItemClient() {
        ...
        consumer.accept(new GeoRenderProvider() {
            ...
            public <T extends LivingEntity> BipedEntityModel<?> getGeoArmorRenderer(
                ...
                if (this.renderer == null)
                    this.renderer = new DyeableLegginsRenderer();
